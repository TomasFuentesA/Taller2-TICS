...
class Mediciones(models.Model):
    medicionid = models.AutoField(primary_key=True)
    luz = models.IntegerField(blank=True, null=True)
    ...
    id_riego = models.IntegerField(blank=True, null=True)
...
class Riego(models.Model):
    riegoid = models.AutoField(primary_key=True)
